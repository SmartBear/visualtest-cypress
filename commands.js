    ...
    if (vtConfFile.fail) {
        ...
        cy.window()
            .then((win) => {
                    ...
                    if (numScrolls > 1 && modifiedOptions.scrollMethod !== "JS_SCROLL") { // a scrollable page & scroll: "JS" is so if a user complains they can use the cypress default fullpage capture
